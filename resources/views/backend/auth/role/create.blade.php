                                        ...
                                        @foreach($permissions as $permission)
                                            <div class="checkbox d-flex align-items-center">
                                                {{ html()->label(
                                                    ...
                                                    @if ($permission->package_name)
                                                        {{ html()->label(__($permission->package_name.'::permissions.'.$permission->name))->for('permission-'.$permission->id) }}
                                                    @else
                                                        {{ html()->label(__('permissions.'.$permission->name))->for('permission-'.$permission->id) }}
                                                    @endif
                                            </div>
                                        @endforeach
                                    </fieldset>
