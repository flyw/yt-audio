            ...
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <div class='btn-group'>
                        ...
                        <button class="btn btn-dropbox btn-sm" type="button" data-toggle="collapse" data-target="#collapseUploadAliyunDrive{!! $download->id !!}" aria-expanded="false" aria-controls="collapseUploadAliyunDrive{!! $download->id !!}">
                            <i class="fas fa-upload"></i> 上传云盘
                        </button>
                        @endif
                    ...
                    <div class="collapse" id="collapseUploadAliyunDrive{!! $download->id !!}">
                        <div class="card card-body">
                            <span class="code small">
